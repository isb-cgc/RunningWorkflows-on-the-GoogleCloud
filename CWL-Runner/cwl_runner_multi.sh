...
-D --settings-dest PATH
  REQUIRED. The location to upload the settings file in Cloud Storage.
-v --var-input KEY1=PATH1;KEY2=PATH2:[KEY1=PATH1;KEY2=PATH2]
  List of paths to populate the settings file.
...
gsutil cp "${SETTINGS_FILE}" "${SETTINGS_DEST}"
